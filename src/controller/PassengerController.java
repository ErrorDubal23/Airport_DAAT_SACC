...
public class PassengerController {
    ...
    // Validaciones básicas de campos vacíos
    if (idStr.isEmpty()) return Response.fieldRequired("ID");
    if (firstName.isEmpty()) return Response.fieldRequired("nombre");
    if (lastName.isEmpty()) return Response.fieldRequired("apellido");
    if (birthYearStr.isEmpty()) return Response.fieldRequired("año de nacimiento");
    if (birthMonthStr.isEmpty()) return Response.fieldRequired("mes de nacimiento");
    if (birthDayStr.isEmpty()) return Response.fieldRequired("día de nacimiento");
    if (phoneCodeStr.isEmpty()) return Response.fieldRequired("código de teléfono");
    if (phoneNumberStr.isEmpty()) return Response.fieldRequired("número de teléfono");
    if (country.isEmpty()) return Response.fieldRequired("país");
